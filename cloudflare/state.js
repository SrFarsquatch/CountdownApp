...
export function normalizeMarkets(x={}){
  ...
  return{watchlist,refreshMinutes:clamp(Math.round(num(x.refreshMinutes,15)),5,1440),credential:typeof x.credential==='string'?x.credential:null};
}
